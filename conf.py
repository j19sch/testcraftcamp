...
BLOG_AUTHOR = "TestCraftCamp"  # (translatable)
BLOG_TITLE = "TestCraftCamp"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://testcraftcamp.nl/"
...
# to avoid a conflict with pages because blogs try to generate /index.html
INDEX_PATH = "blog"
...
FAVICONS = (
    ("icon", "/cropped-TCC-logo-1-32x32.png", "32x32"),
    ("icon", "/cropped-TCC-logo-1-192x192.png", "192x192"),
)
